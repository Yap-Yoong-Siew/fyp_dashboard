...
//|                        Copyright © 2017-2022, Yap Yoong Siew.com |
//|                                    https://www.yapyoongsiew.com/ |
//+------------------------------------------------------------------+
#property copyright "Yap Yoong Siew.com"
#property link      "https://www.earnforex.com/metatrader-expert-advisors/Account-Protector/"
#property version   "1.013"
string    Version = "1.013";
#property strict
...
input bool DoNotDisableTimer = true; // DoNotDisableTimer: Don't disable timer on trigger?
input bool AlertOnEquityTS = false; // AlertOnEquityTS: Alert when equity trailing stop triggers?
input bool DisableFloatLossRisePerc = true; // Disable floating loss rises % condition.
...
input bool DisableFloatLossRisePoints = true; // Disable floating loss rises points condition.
input bool DisableFloatLossFallPoints = true; // Disable floating loss falls points condition.
input bool DisableFloatProfitRisePerc = true; // Disable floating profit rises % condition.
input bool DisableFloatProfitFallPerc = true; // Disable floating profit falls % condition.
input bool DisableFloatProfitRiseCurr = true; // Disable floating profit rises currency units condition.
input bool DisableFloatProfitFallCurr = true; // Disable floating profit falls currency units condition.
input bool DisableFloatProfitRisePoints = true; // Disable floating profit rises points condition.
...
input bool DisableDailyProfitLossUnitsLE = false; // Disable daily profit/loss level less or equal units condition.
...
input bool DisableDailyProfitLossPercLE = false; // Disable daily profit/loss level less or equal percentage condition.
...
int OnInit()
{
    ...
    if (!ExtDialog.LoadSettingsFromDisk())
    {
        ...
        sets.UseTimer = true;
        sets.Timer = "00:00"; //TimeToString(TimeCurrent() - 7200, TIME_MINUTES);
        sets.TimeLeft = "";
        sets.intTimeType = 0;
        ...
        sets.doubleEquityLessPerSnap = 96;
